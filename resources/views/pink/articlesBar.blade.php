    ...
    <div class="recent-post group">
        @if(!$portfolios->isEmpty())
            ...
            <div class="hentry-post group">
                <div class="thumb-img"><img style="width: 55px" src="{{ asset(env('THEME')) }}/images/{{ config('settings.portfolios_path') }}/{{ $portfolio->img->mini }}" alt="{{ $portfolio->title }}" title="{{ $portfolio->title }}"/></div>
                <div class="text">
